...
- Пресет мира `gravesown:after_the_silence` и единственный биом
  `gravesown:sown_grave` с оригинальной мрачной палитрой неба, тумана и воды.
- Собственная генерация низких холмов: Ashen Sod, три слоя Grave Loam, Hushstone,
  Deep Hushstone и сплошной Gravebed без ванильных жидкостей, аквиферов, руд,
  карверов, features и структур.
- Пятнадцатый GameTest фиксирует контракты динамических реестров биома, noise
  settings и world preset, включая единственный естественный спавн Пустопаса.
- `clienttest.cmd`: изолированный quick-play smoke-test того же seed на клиенте и
  integrated server с автоматическим PASS-маркером, сохранением и завершением.
