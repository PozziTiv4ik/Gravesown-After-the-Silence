...
public final class NativeFaunaRenderer extends MobRenderer<NativeFauna, NativeFaunaModel> {
    public NativeFaunaRenderer(EntityRendererProvider.Context context, NativeFaunaSpecies species) {
        super(context, new NativeFaunaModel(context.bakeLayer(NativeFaunaModel.layer(species)), species), 0.36F);
    }
