...
|---|---|---|---|---|---|---|---|---|---|---|
| hollow_grazer | Creature | Neutral grazer that hunts wounded players and becomes aggressive at night | M1 | Overworld | Alpha | Alpha; visual QA pending | Original alpha; visual QA pending | Temporary vanilla drops | Implemented | GameTest PASS; in-world pending |
